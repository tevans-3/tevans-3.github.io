...
pub fn all_projects() -> Vec<Project> {
    vec![
        Project::planned("Bikescape", "Embedded device straps to a bike frame and uses environmental sound classification to generate real-time visualizations of your bike route with safety-coded heatmaps and other nifty stuff not yet dreamt of in heaven or earth", ""), 
