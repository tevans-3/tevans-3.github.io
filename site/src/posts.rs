...
fn metallica_post() -> BlogPost {
    ...
    .paragraph("You probably won't make any money from handwriting RISC-V assembly, and if you're like me and don't have a brain you won't profit by learning much either. You can't benefit from a brain stretcher if you don't have a brain to begin with. So why even bother doing this? B-b-because--")
    ...
    .image_with_alt("../../rp2350.png", "RP2350 microprocessor")
...
topology:
  ...
  links:
    ...
    .image_with_alt("../../deployed-lab.png", "Deployed containerlab")
    ...
    .image_with_alt("../../graph-topology.png", "Graph topology")
